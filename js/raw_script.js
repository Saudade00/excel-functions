const FUNCTIONS = [
  ...
  {
    name: 'ACCRINT',
    description: '返回定期付息有价证券的应计利息',
    category: '财务函数',
    usage: 'ACCRINT(issue，first_interest，settlement，rate，par，frequency，basis)',
    params: '',
    notes:
      'Issue为有价证券的发行日，First_interest是证券的起息日，Settlement是证券的成交日(即发行日之后证券卖给购买者的日期)，Rate为有价证券的年息票利率，Par为有价证券的票面价值(如果省略par，函数ACCRINT将par看作const FUNCTIONS = 000)，Frequency为年付息次数(如果按年支付，frequency=1;按半年期支付，frequency=2;按季支付，frequency=4)。',
    example: '',
    rating: '★★★★★',
    stars: '★★★★★',
    hasDetail: true,
  ...
  {
    name: 'ACCRINTM',
    description: '返回到期一次性付息有价证券的应计利息',
    category: '财务函数',
    usage: 'ACCRINTM(issue，maturity，rate，par，basis)',
    params:
  ...
  {
    name: 'AMORDEGRC',
    description: '返回每个会计期间的折旧值.此函数是为法国会计系统提供的',
    category: '财务函数',
    usage: 'AMORDEGRC(cost，date_purchased，first_period，salvage，period，rate，basis)',
    params:
  ...
  {
    name: 'AMORLINC',
    description: '返回每个会计期间的折旧值,该函数为法国会计系统提供',
    category: '财务函数',
    usage: 'AMORLINC(cost，date_purchased，first_period，salvage，period，rate，basis)',
    params:
  ...
  {
    name: 'AND',
    description: '查看是否满足所有条件',
    category: '逻辑函数',
    usage: '',
    params: '参数用逗号分开,最多可以指定30个.',
    notes:
      '和IF函数嵌套使用,可以根据AND函数的判定结果,依据条件分开处理.检测所有的条件是否为真(AND为所有条件满足.OR为任意一个条件满足)',
    example: '',
    rating: '★★★★★',
    stars: '★★★★★',
    hasDetail: true,
  ...
  {
    name: 'AREAS',
    description: '计算指定范围的领域数',
    category: '查找与引用函数',
    usage: 'AREAS(reference)',
    params: 'Reference是对某一单元格或单元格区域的引用，也可以引用多个区域',
    notes:
  ...
  {
    name: 'ASC',
    description: '将字符串中的全角英文字母转换为半角字符',
    category: '文本函数',
    usage: '',
    params: '',
    notes: '',
  ...
  },
  {
    ...
    params: 'Number1、number2、...是用来计算绝对偏差平均值的一组参数，其个数可以在1～30个之间',
    notes: '',
    example: '',
    rating: '',
    stars: '',
  ...
  },
  {
    ...
    params:
      'range：条件判断的范围；criteria：条件（支持比较运算符和通配符）；average_range：可选，实际求平均的范围（省略则对 range 求平均）',
    notes:
      'AVERAGEIF 忽略空白单元格和文本。条件需要用引号括起来，如 ">80"。通配符 ? 和 * 可用在条件中。',
  ...
  {
    name: 'BESSELI',
    description: '返回第1种修正Bessel函数值Kn(x)',
    category: '工程函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'BESSELJ',
    description: '返回第1种Bessel函数值Kn(x)',
    category: '工程函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'BESSELK',
    description: '返回第2种修正Bessel函数值Kn(x)',
    category: '工程函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'BESSELY',
    description: '返回第2种Bessel函数值Kn(x)',
    category: '工程函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'CEILNG',
    description: '将参数Number沿绝对值增大的方向,舍入为最接通近的整数或基数',
    category: '数学与三角函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'CHOOSE',
    description: '从参数列表中选择值',
    category: '查找与引用函数',
    usage: 'CHOOSE(index_num，value1，value2，...)',
    params:
  ...
  {
    name: 'CLEAN',
    description: '删除文本中不能打印的字符',
    category: '文本函数',
    usage: 'CLEAN(text)。',
    params: 'Text为要从中删除不能打印字符的任何字符串',
    notes: '',
    example: '',
    rating: '★★★★★',
    stars: '★★★★★',
  ...
  },
  {
    ...
    params: 'reference为引用的单元格',
    notes:
      '如果在B11单元格中输入公式:=COLUMN(),也显示出2;与之相对应的还有一个返回行标号值的函数——ROW(reference).',
    example: '在C11单元格中输入公式:=COLUMN(B11),确认后显示为2（即B列）',
    rating: '★★★★★',
    stars: '★★★★★',
    hasDetail: true,
  },
  ...
  {
    name: 'CONCATENATE',
    description: '将若干文字串合并到一个文字串中',
    category: '文本函数',
    usage: 'CONCATENATE(Text1，Text……)',
    params: 'Text1、Text2……为需要连接的字符文本或引用的单元格',
    notes:
  ...
  {
    name: 'CONVERT',
    description: '将数字从一个度量系统转换到另一个度量系统中',
    category: '工程函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'COUNTIF',
    description: '计算给定区域内满足特定条件的单元格的数目',
    category: '统计函数',
    usage: '',
    params:
      'RANGE=指定作为搜索对象的单元格区域.即找是否有与条件相配的单元格区域.CRITERIA=指定搜索RANGE单元格的"条件",即说明条件.',
    notes:
      '指定的条件必须用 " " (双引号括起来),如 ">=100、"男" 等.但,当指定条件为引用单元格时无需双引号括住.通配\n符使用参看SUMIF函数中的通配符说明.',
    example: '',
    rating: '★★★☆☆',
    stars: '★★★☆☆',
    hasDetail: true,
  ...
  {
    name: 'COUPNUM',
    description: '返回成交日和到期日之间的利息应付次数',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'CRITBINOM',
    description: '返回使累积二项式分布大于等于临界值的最小值',
    category: '统计函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'CUMIPMT',
    description: '返回贷款在给定期间累计偿还和利息数额',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'CUMPRINC',
    description: '返回贷款在给定期间累计偿还和本金数额',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'DATE',
    description: '通过年、月或日返回日期',
    category: '日期与时间函数',
    usage: 'DATE(year,month,day)',
    params:
      '参数 year 可以为一到四位.Excel 将根据所使用的日期系统解释 year 参数.Excel支持1900年和1904年两种日期系统,这两种日期系统使用了不同的日期作为参照基础,00年日期系统规定1900年的1月1日为第一天,其存储的日期系列编号为1,最后天是9999年12月31日.04日期系统规定1904年1月1日为第一天,基存储的日期系列为0,最后一天同上.系统默认为1900日期系统.',
    notes:
      'Excel按顺序的序列号保存日期，这样就可以对其进行计算。如果工作簿使用的是1900日期系统，则Excel会将1900年1月1日保存为序列号1。同理，会将1998年1月1日保存为序列号35796，因为该日期距离1900年1月1日为35795天',
    example: '',
    rating: '★★☆☆☆',
    stars: '★★☆☆☆',
    hasDetail: true,
  ...
  {
    name: 'DATEDIF',
    description: '计算期间内的天数、月数或年数',
    category: '日期与时间函数',
    usage: 'DATEDIF(date1,date2,"y")、=DATEDIF(date1,date2,"m")、=DATEDIF(date1,date2,"d")',
    params:
  ...
  {
    name: 'DATEVALUE',
    description: '将以文字表示的日期转换成系列数',
    category: '日期与时间函数',
    usage: 'DATEVALUE(date_text)',
    params:
      'Date_text是用Excel日期格式表示日期的文本。在使用1900日期系统中，date_text必须是1900年1月1日到9999年12月31日之间的一个日期;而在1904日期系统中，date_text必须是1904年1月1日到9999年12月31日之间的一个日期。如果date_text超出上述范围，则函数DATEVaLUE返回错误值#value!',
    notes:
  ...
  {
    name: 'DAVERAGE',
    description: '返回满足条件的列的平均',
    category: '数据库函数',
    usage: 'DAVERAGE(database，field，criteria)',
    params:
      'Database构成列表或数据库的单元格区域。Field指定函数所使用的数据列。Criteria为一组包含给定条件的单元格区域。',
    notes: '',
    example: '',
    rating: '★★★★★',
    stars: '★★★★★',
  ...
  {
    name: 'DAYS360',
    description: '按照一年360天的算法,返回两日期间相差的天数',
    category: '日期与时间函数',
    usage: 'DAYS360(start_date，end_date，method)',
    params:
      'Start_date和end_date是用于计算期间天数的起止日期。如果start_date在end_date之后，则DAYS360将返回一个负数。日期可以有多种输入方式:带引号的文本串(例如:"1998/01/30")、序列号(例如:如果使用1900日期系统，则35825表示1998年1月30日)或其他公式或函数的结果(例如，DATEVaLUE("1998/1/30"))。',
    notes:
  ...
  {
    name: 'DEVSQ',
    description: '返回数据点与各自样本均值偏差的平方和',
    category: '统计函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'DOLLARDE',
    description: '将按分数表示的美元价格转换为按小数表示',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'DOLLARFR',
    description: '将按小数表示的美元价格转换为按分数表示',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'EVEN',
    description: '返回沿绝对值增大方向取整后最接近的偶数',
    category: '数学与三角函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'EXACT',
    description: '比较文本,查看是否相等',
    category: '文本函数',
    usage: 'EXACT(text1，text2)。',
    params: 'Text1是待比较的第一个字符串，Text2是待比较的第二个字符串。',
    notes: '',
    example: '',
    rating: '★★★★★',
    stars: '★★★★★',
  ...
  {
    name: 'FIXED',
    description: '将数值带上千位分隔符和小数点标记',
    category: '文本函数',
    usage: 'FIXED(number，decimals，no_commas)。',
    params:
      'Number是要进行四舍五入并转换成文字串的数;Decimals为一数值，用以指定小数点右边的小数位数;No_commas为一逻辑值。如果是TRUE，则函数FIXED返回的文字不含逗号。如果no_commas是FALSE或省略，则返回的文字中包含逗号',
    notes: '',
    example: '',
    rating: '★★★★★',
    stars: '★★★★★',
  ...
  {
    name: 'FLOOR',
    description: '将参数沿绝对值减小的方向去尾舍入,使其等于最接近的倍数',
    category: '数学与三角函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'GETPIVOTDATA',
    description: '(2003/2000)从枢表中读取数据',
    category: '查找与引用函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'HYPERLINK',
    description: '创建快捷方式或跳转，以打开存储在网络服务器、Intranet或Internet上的文档',
    category: '查找与引用函数',
    usage: 'HYPERLINK(link_location，friendly_name)',
    params:
      'Link_location是文件的路径和文件名，它还可以指向文档中的某个更为具体的位置，如Execl工作表或工作簿中特定的单元格或命名区域，或是指向Word文档中的书签。路径可以是存储在硬盘驱动器上的文件，或是Internet或Intranet上的URL路径；Friendly_name为单元格中显示的链接文字或数字，它用蓝色显示并带有下划线。如果省略了Friendly_name，单元格就将link_location显示为链接。',
    notes: '',
    example: '',
    rating: '★★★★★',
    stars: '★★★★★',
  ...
  },
  {
    ...
    category: '逻辑函数',
    usage: 'IF(Logical,Value_if_true,Value_if_false)',
    params: '参数用逗号分开,最多可以指定30个.',
    notes: '03版中最多可以嵌套使用7个IF函数;07版中最多可以嵌套64个IF函数.',
    example: '',
    rating: '★★★★★',
    stars: '★★★★★',
    hasDetail: true,
  ...
  {
    name: 'IMARGUMENT',
    description: '返回参数 theta，一个以弧度表示的角度',
    category: '工程函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'INT',
    description: '将数字向下舍入为最接近的整数',
    category: '数学与三角函数',
    usage: '',
    params: 'INT(number)  指定数值或数值所在的单元格费用.参数只能指定一个,且不能指定单元格区域.',
    notes: '在取整时，不进行四舍五入；如果输入的公式为=INT(-18.89)，则返回结果为-19',
    example: '',
    rating: '★☆☆☆☆',
    stars: '★☆☆☆☆',
    hasDetail: true,
  ...
  {
    name: 'ISNA',
    description: '如果值为 #N/A 错误值，则返回 TRUE',
    category: '信息函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'JIS',
    description: '将字符串中的半角(单字节)英文字母更改为全角(双字节)字符',
    category: '文本函数',
    usage: '',
    params: '',
    notes: '',
  ...
  },
  {
    ...
    category: '文本函数',
    usage: 'LOWER(text)',
    params: 'Text是包含待转换字母的文字串',
    notes: 'LOWER函数不改变文字串中非字母的字符。LOWER与PROPER和UPPER函数非常相似。',
    example: '',
    rating: '★★★★★',
    stars: '★★★★★',
    hasDetail: true,
  },
  {
    ...
    example: '在F2单元格中输入公式：=MATCH(E2,B1:B11,0)，确认后则返回查找的结果“9”。',
    rating: '★★★★★',
    stars: '★★★★★',
    hasDetail: true,
  },
  ...
  {
    name: 'MDURATION',
    description: '返回假设面值为 const FUNCTIONS = 00 的有价证券的 Macauley 修正期限',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'MIRR',
    description: '返回正负现金流在不同利率下支付的内部收益率',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  },
  {
    ...
    category: '逻辑函数',
    usage: '',
    params: '指定检测为TRUE(真)或FALSE(假)的逻辑表达式.,不能指定多个参数.',
    notes: '当计算AND函数或OR函数的结果的反结果时使用.',
    example: '',
    rating: '★★☆☆☆',
    stars: '★★☆☆☆',
    hasDetail: true,
  },
  {
    ...
    usage: 'NOW()',
    params: '该函数不需要参数',
    notes: '显示出来的日期和时间格式，可以通过单元格格式进行重新设置',
    example:
  ...
  {
    name: 'NPV',
    description: '基于一系列定期的现金流和贴现率，返回一项投资的净现值',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'ODDFPRICE',
    description: '返回首期付息日不固定的面值 const FUNCTIONS = 00 的有价证券的价格',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'ODDFYIELD',
    description: '返回首期付息日不固定的有价证券的收益率',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'ODDLPRICH',
    description: '返回末期付息日不固定的面值 const FUNCTIONS = 00 的有价证券的价格',
    category: '其他函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'ODDLYIELD',
    description: '返回末期付息日不固定的有价证券的收益率',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'OR',
    description: '如果任一参数为TRUE，则返回TRUE',
    category: '逻辑函数',
    usage: '',
    params: 'OR(logical1,logical2, ...)  参数用逗号分开,最多可以指定30个.',
    notes:
      '和IF函数嵌套使用,可以根据AND函数的判定结果,依据条件分开处理.如果指定的逻辑条件参数中包含非逻辑值时，则函数返回错误值“#VALUE!”或“#NAME”',
    example: '',
    rating: '★★★★★',
    stars: '★★★★★',
    hasDetail: true,
  ...
  {
    name: 'PPMT',
    description: '返回投资在某一给定期间内的本金偿还额',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'PRICE',
    description: '返回定期付息的面值 const FUNCTIONS = 00 的有价证券的价格',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'PRICEDISC',
    description: '返回折价发行的面值 const FUNCTIONS = 00 的有价证券的价格',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'PRICEMAT',
    description: '返回到期付息的面值 const FUNCTIONS = 00 的有价证券的价格',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'PROPER',
    description: '将文本值中每一个单词的首字母设置为大写',
    category: '文本函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'QUOTIENT',
    description: '返回商的整数部分，即舍去商的小数部分。',
    category: '数学与三角函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'RADANS',
    description: '将一个表示角度的数值或参数转换为弧度。',
    category: '其他函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'RAND',
    description: 'R回一个大于等于0小于1的随机数，每次计算工作表(按F9键)将返回一个新的数值。',
    category: '数学与三角函数',
    usage: 'RAND()',
    params:
      '没有参数,返回的数值具有随机性,因此同一公式返回的值并不相同,而且只要对工作簿进行过任何修改或关闭后重新打开工作簿,该函数都会随机返回一个新的数值取代原来的数值.',
    notes: '',
    example: '',
    rating: '★★☆☆☆',
    stars: '★★☆☆☆',
  ...
  {
    name: 'RATE',
    description: '返回年金的各期利率。函数RATE通过迭代法计算得出，并且可能无解或有多个解。',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'REPLACEB',
    description: '根据所指定的字节数替换另一文本串中的部分文本',
    category: '文本函数',
    usage: '',
    params: '',
    notes: '',
  ...
  },
  {
    ...
    params: '',
    notes: '',
    example: '用REPT函数模拟简单条形图,以更直观的形式反映销售情况.',
    rating: '★★☆☆☆',
    stars: '★★☆☆☆',
    hasDetail: true,
  },
  ...
  {
    name: 'ROMAN',
    description: '将阿拉伯数字转换为文本形式的罗马数字。',
    category: '数学与三角函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'RSQ',
    description: '返回给定数据点的Pearson乘积矩相关系数的平方。',
    category: '统计函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'RTD',
    description: '从支持COM自动化的程序中返回实时数据。',
    category: '查找与引用函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'SECOND',
    description: '返回时间值的秒数(为0至59之间的一个整数)。',
    category: '日期与时间函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'SIGN',
    description: '返回数字的符号。正数返回1，零返回0，负数时返回-1。',
    category: '数学与三角函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'SLN',
    description: '返回某项资产在一个期间中的线性折旧值',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'SMALL',
    description: '返回数据集中第k个最小值，从而得到数据集中特定位置上的数值。',
    category: '统计函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'STANDARDIZE',
    description: '返回以mean为平均值，以standard-dev为标准偏差的分布的正态化数值。',
    category: '统计函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'STDEV',
    description: '估算样本的标准偏差。它反映了数据相对于平均值(mean)的离散程度。',
    category: '统计函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'STDEVP',
    description: '返回整个样本总体的标准偏差。它反映了样本总体相对于平均值(mean)的离散程度。',
    category: '统计函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'STEYX',
    description: '返回通过线性回归法计算y预测值时所产生的标准误差',
    category: '统计函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'SUBSTITUTE',
    description: '在文字串中用new_text替代old_text',
    category: '文本函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'SUM',
    description: '对满足条件的单元格的数值求和',
    category: '数学与三角函数',
    usage: 'SUM（Number1‚Number2……）',
    params: '参数用逗号分开,最多可以指定30个.',
    notes:
      '可以作为计算对象的有数值、作为文本输入的数字,以及包含上述数值的单元格.空白单元格被视为0计算. 如果参数为数组或引用，只有其中的数字将被计算。数组或引用中的空白单元格、逻辑值、文本或错误值将被忽略；如果\n将上述公式修改为：=SUM(LARGE(D2:D63,{1,2,3,4,5}))，则可以求出前5名成绩的和。',
    example:
  ...
  {
    name: 'SUMIF',
    description: '根据指定条件对若干单元格、区域或引用求和',
    category: '数学与三角函数',
    usage: 'SUMIF（Range‚Criteria‚Sum_Range）',
    params:
      'RANGE=指定作为搜索对象的单元格区域.即找是否有与条件相配的单元格区域.CRITERIA=指定搜索RANGE单元格的"条件",即说明条件.SUM_RANGE=指定求和对象的单元格区域.即要求求和的行或列.',
    notes:
      '指定的条件必须用 " " (双引号括起来),如 ">=100、"男" 等.但,当指定条件为引用单元格时无需双引号括住.\n使用SUMIF比VLOOKUP查找更方便,可以避免无匹配时返回的错误的问题.',
    example: '',
    rating: '★★★★★',
    stars: '★★★★★',
    hasDetail: true,
  ...
  {
    name: 'SUMPRODUCT',
    description: '在给定的几组数组中，将数组间对应的元素相乘，并返回乘积之和',
    category: '数学与三角函数',
    usage: '',
    params:
      '指定包含构成计算对象的有数值逻辑值或作为文本输入的数字的数组常量,或者包含这些值的单元格区域,空白单元格被视为0.即,几行或列相乘后再相加.',
    notes: '当参数的指定行×列大小不一样数组时,会返回错误值"#VALUE!".',
    example:
      '此函数只是少一个小计就能得出结果,也可用=SUM(PRODUCT(B10,C10,E10),PRODUCT(B11,C11,E11),PRODUCT(B12,C12,E12))',
    rating: '★★★☆☆',
    stars: '★★★☆☆',
    hasDetail: true,
  },
  {
    name: 'SUMSQ',
    description: '返回所有参数的平方和',
    category: '数学与三角函数',
    usage: '',
    params:
      '指定想要乘积的值,或单元格引用.也可指定单元格区域.参数数量和SUM一样(30个).即想要计算的单元格.',
    notes: '空白单元格被视为0进行计算',
    example: '公式“=SUMPRODUCT({3，4;8，6;1，9}，{2，7;6，7;5，3})”的计算结果是156',
    rating: '★★☆☆☆',
    stars: '★★☆☆☆',
    hasDetail: true,
  },
  ...
  {
    name: 'SYD',
    description: '返回某项资产按年限总和折旧法计算的指定期间的折旧值',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'TBILLPRICH',
    description: '返回面值const FUNCTIONS = 00的国库券的价格',
    category: '其他函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'TEXT',
    description: '将数值转换为按指定数字格式表示的文本',
    category: '文本函数',
    usage: 'TEXT(value,format_text)',
    params:
      'RANGE=指定作为搜索对象的单元格区域.即找是否有与条件相配的单元格区域.CRITERIA=指定搜索RANGE单元格的"条件",即说明条件.SUM_RANGE=指定求和对象的单元格区域.即要求求和的行或列.',
    notes:
      '指定的条件必须用 " " (双引号括起来),如 ">=100、"男" 等.但,当指定条件为引用单元格时无需双引号括住. format_text参数可以根据“单元格格式”对话框“数字”标签中的类型进行确定。',
    example: '',
    rating: '★★★☆☆',
    stars: '★★★☆☆',
    hasDetail: true,
  ...
  {
    name: 'TINV',
    description: '返回作为概率和自由度函数的学生氏t分布的t值',
    category: '统计函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'TODAY',
    description: '返回系统当前日期的序列号',
    category: '日期与时间函数',
    usage: 'TODAY()',
    params: '该函数不需要参数.',
    notes:
      '输入公式：=TODAY()，确认后即刻显示出系统日期和时间。如果系统日期和时间发生了改变，只要按一下F9功能键，即\n可让其随之改变.',
    example: '',
    rating: '★★☆☆☆',
    stars: '★★☆☆☆',
    hasDetail: true,
  ...
  {
    name: 'TREND',
    description: '返回一条线性回归拟合线的一组纵坐标值(y值)',
    category: '统计函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'TRIM',
    description: '除了单词之间的单个空格外，清除文本中的所有的空格',
    category: '文本函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'VALUE',
    description: '将表示数字的文字串转换成数字',
    category: '文本函数',
    usage: 'VALUE(text)',
    params: 'text代表需要转换文本型字符串数值',
    notes: '如果文本型数值不经过上述转换，在用函数处理这些数值时，常常返回错误',
    example:
  ...
  {
    name: 'VDB',
    description: '使用余额递减法，返回指定期间内或部分期间内的某项资产折旧值',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  },
  {
    ...
    params: '英文字母不区分大小写;右移列数从第一列开始;搜索区域为含条件列至结果列.',
    notes:
      '适用于纵长的表格的搜索,搜索的列通常为首列.当搜索不到满足值时,返回错误值"#N/A".当超出搜索区域时,返回错误值"#REF". Lookup_value参见必须在Table_array区域的首列中；如果忽略Range_lookup参数，则Table_array的首列必须进行排序；在此函数的向导中，有关Range_lookup参数的用法是错误的',
    example: '',
    rating: '★★☆☆☆',
    stars: '★★☆☆☆',
    hasDetail: true,
  },
  {
    ...
    params:
      'lookup_value：要查找的值；lookup_array：查找数组（行或列）；return_array：返回数组；if_not_found：找不到时返回的值（省略则返回#N/A）；match_mode：匹配模式（0=精确匹配，1=近似匹配，-1=精确匹配或下一个更小值，2=通配符匹配）；search_mode：搜索模式（1=从上到下，-1=从下到上，2=二进制升序，-2=二进制降序）',
    notes:
      'XLOOKUP 是 VLOOKUP 的升级版，可以向左查找、不需要排序列、默认精确匹配。支持模糊查找和反向查找。',
    example:
      '=XLOOKUP("苹果", A:A, B:B, "未找到") —— 在 A 列查找「苹果」，返回 B 列对应值，找不到返回「未找到」',
    rating: '★★★★★',
    stars: '★★★★★',
    hasDetail: true,
  },
  {
    ...
    params:
      'array：要筛选的数组或范围；include：布尔值数组（TRUE/FALSE），指定筛选条件；if_empty：可选，当没有匹配项时返回的值（省略则返回#CALC!）',
  ...
  },
  {
    ...
    params:
      'array：要提取唯一值的数组或范围；by_col：可选，TRUE 按列比较，FALSE 或省略按行比较；exactly_once：可选，TRUE 只返回只出现一次的值，FALSE 或省略返回所有唯一值',
  ...
  },
  {
    ...
    params:
      'array：要排序的数组或范围；sort_index：可选，按第几列/行排序（默认1）；sort_order：可选，1=升序（默认），-1=降序；by_col：可选，TRUE 按列排序，FALSE 或省略按行排序',
  ...
  {
    name: 'WEEKDAY',
    description: '返回某日期的星期数',
    category: '日期与时间函数',
    usage: 'WEEKDAY(serial_number,return_type)',
    params:
      'serial_number代表指定的日期或引用含有日期的单元格；return_type代表星期的表示方式[当Sunday（星期日）为1、Saturday（星期六）为7时，该参数为1；当Monday（星期一）为1、Sunday（星期日）为7时，该参数为2（这种情况符合中国人的习惯）；当Monday（星期一）为0、Sunday（星期日）为6时，该参数为3]。',
    notes: '如果是指定的日期，请放在英文状态下的双引号中，如=WEEKDAY("2003-12-18",2)',
    example: '输入公式：=WEEKDAY(TODAY(),2)，确认后即给出系统日期的星期数。',
    rating: '★★☆☆☆',
    stars: '★★☆☆☆',
    hasDetail: true,
  },
  {
    name: 'WEEKNUM',
    description: '返回一个数字，该数字代表一年中的第几周',
    category: '日期与时间函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'WORKDAY',
    description: '返回指定工作日数之前或之后某日期的序列号',
    category: '日期与时间函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'XIRR',
    description: '返回一组不定期发生的现金流的内部收益率',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'YEAP',
    description: '返回某日期的年份。其结果为1900到9999之间的一个整数',
    category: '其他函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'YEARFRAC',
    description: '返回start_date和end_date之间的天数占全年天数的百分比',
    category: '日期与时间函数',
    usage: '',
    params: '',
    notes: '',
  ...
  {
    name: 'YIELD',
    description: '返回定期付息有价证券的收益率，函数YIELD用于计算债券收益率',
    category: '财务函数',
    usage: '',
    params: '',
    notes: '',
...
function toggleFav(fnName, e) {
  ...
  if (favSet.has(fnName)) favSet.delete(fnName);
  else favSet.add(fnName);
  saveFavs([...favSet]);
  render();
...
const allTag = createTag(
  'all',
  '全部',
  Object.values(CAT_COUNTS).reduce((a, b) => a + b, 0),
  '#2563eb',
  '#eff6ff',
  true
);
...
function getFiltered() {
  ...
  const diff = document.getElementById('diffSelect')
    ? document.getElementById('diffSelect').value
    : 'all';
  ...
  grid.innerHTML = fns
    .map((f) => {
      ...
      const diffBadge = diff
        ? `<div class="card-diff-badge diff-${diff}">${DIFF_LABELS[diff]}</div>`
        : '';
...
function buildCanvas(el) {
  ...
  el.querySelectorAll('.modal-section').forEach((sec) => {
    ...
    if (usageBlock) {
      content = usageBlock.textContent.trim();
      type = 'code';
    } else if (paramsBlock) {
      content = paramsBlock.textContent.trim();
      type = 'params';
    } else if (exBlock) {
      content = exBlock.textContent.trim();
      type = 'example';
    } else if (notesBlock) {
      content = notesBlock.textContent.trim();
      type = 'notes';
    } else if (plainBlock) {
      content = plainBlock.textContent.trim();
      type = 'plain';
    }
...
document.addEventListener('keydown', (e) => {
  if (e.key === 'Escape') {
    if (document.getElementById('wrongBookModal').classList.contains('open')) {
      closeWrongBookBtn();
      return;
    }
    if (document.getElementById('quizCenter').classList.contains('open')) {
      closeQuizCenter();
      return;
    }
    closeModalBtn();
...
const QUIZ_DATA = {
  ABS: [
    {
      ...
      options: ['数学与三角函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  ACCRINT: [
    {
      ...
      options: ['财务函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  ADDRESS: [
    {
      ...
      options: ['查找与引用函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  AND: [
    {
      ...
      options: ['逻辑函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  ASC: [
    {
      ...
      options: ['文本函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  AVEDEV: [
    {
      ...
      options: ['统计函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  BESSELI: [
    {
      ...
      options: ['工程函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  CALL: [
    {
      ...
      options: ['外部函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  CELL: [
    {
      ...
      options: ['信息函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  DATE: [
    {
      ...
      options: ['日期与时间函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  DAVERAGE: [
    {
      ...
      options: ['数据库函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  HYPERLINK: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'HYPERLINK 函数的功能是：创建快捷方式或跳转，以打开存储在网络服务器、Intranet或Internet上的文档',
    },
    {
      type: 'fillBlank',
  ...
  MDURATION: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'MDURATION 函数的功能是：返回假设面值为 const FUNCTIONS = 00 的有价证券的 Macauley 修正期限',
    },
    {
      type: 'fillBlank',
  ...
  N类: [
    {
      type: 'choice',
      question: 'N类 函数属于哪一类？',
      options: ['其他函数', '文本函数', '日期与时间函数', '数据库函数'],
      answer: 0,
  ...
  ODDFPRICE: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'ODDFPRICE 函数的功能是：返回首期付息日不固定的面值 const FUNCTIONS = 00 的有价证券的价格',
    },
    {
      type: 'fillBlank',
  ...
  ODDLPRICH: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'ODDLPRICH 函数的功能是：返回末期付息日不固定的面值 const FUNCTIONS = 00 的有价证券的价格',
    },
    {
      type: 'fillBlank',
  ...
  PRICEDISC: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'PRICEDISC 函数的功能是：返回折价发行的面值 const FUNCTIONS = 00 的有价证券的价格',
    },
    {
      type: 'fillBlank',
  ...
  PRICEMAT: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'PRICEMAT 函数的功能是：返回到期付息的面值 const FUNCTIONS = 00 的有价证券的价格',
    },
    {
      type: 'fillBlank',
  ...
  RAND: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'RAND 函数的功能是：R回一个大于等于0小于1的随机数，每次计算工作表(按F9键)将返回一个新的数值。',
    },
    {
      type: 'fillBlank',
  ...
  RANDBETWEEN: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'RANDBETWEEN 函数的功能是：产生位于两个指定数值之间的一个随机数，每次重新计算工作表(按F9键)都将返回新的数值。',
    },
    {
      type: 'fillBlank',
  ...
  RANK: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'RANK 函数的功能是：返回一个数值在一组数值中的排位(如果数据清单已经排过序了，则数值的排位就是它当前的位置)',
    },
    {
      type: 'fillBlank',
  ...
  RATE: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'RATE 函数的功能是：返回年金的各期利率。函数RATE通过迭代法计算得出，并且可能无解或有多个解。',
    },
    {
      type: 'fillBlank',
  ...
  SEARCH: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'SEARCH 函数的功能是：返回从start_num开始首次找到特定字符或文本串的位置编号。 其中SEARCH以字符数为单位，SEARCHB以字节数为单位。',
    },
    {
      type: 'fillBlank',
  ...
  SKEW: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'SKEW 函数的功能是：返回一个分布的不对称度.它反映以平均值为中心的分布的不对称程度,正不对称度表示不对称边的分布更趋向正值.负不对称度表示不对称边的分布更趋向负值',
    },
    {
      type: 'fillBlank',
  ...
  SLOPE: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'SLOPE 函数的功能是：返回经过给定数据点的线性回归拟合线方程的斜率(它是直线上任意两点的垂直距离与水平距离的比值，也就是回归直线的变化率)',
    },
    {
      type: 'fillBlank',
  ...
  SMALL: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'SMALL 函数的功能是：返回数据集中第k个最小值，从而得到数据集中特定位置上的数值。',
    },
    {
      type: 'fillBlank',
  ...
  'SQL.REQUEST': [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'SQL.REQUEST 函数的功能是：与外部数据源连接，从工作表运行查询，然后SQL.REQUEST将查询结果以数组的形式返回，而无需进行宏编程。',
    },
    {
      type: 'fillBlank',
  ...
  STANDARDIZE: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'STANDARDIZE 函数的功能是：返回以mean为平均值，以standard-dev为标准偏差的分布的正态化数值。',
    },
    {
      type: 'fillBlank',
  ...
  STDEV: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'STDEV 函数的功能是：估算样本的标准偏差。它反映了数据相对于平均值(mean)的离散程度。',
    },
    {
      type: 'fillBlank',
  ...
  STDEVA: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'STDEVA 函数的功能是：计算基于给定样本的标准偏差。它与STDEV函数的区别是文本值和逻辑值(TRUE或FALSE)也将参与计算。',
    },
    {
      type: 'fillBlank',
  ...
  STDEVP: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'STDEVP 函数的功能是：返回整个样本总体的标准偏差。它反映了样本总体相对于平均值(mean)的离散程度。',
    },
    {
      type: 'fillBlank',
  ...
  SUMPRODUCT: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'SUMPRODUCT 函数的功能是：在给定的几组数组中，将数组间对应的元素相乘，并返回乘积之和',
    },
    {
      type: 'fillBlank',
  ...
  XLOOKUP: [
    ...
    },
    {
      ...
      answer: 0,
      explanation:
        'XLOOKUP 函数的功能是：Office 365 新函数，在表格中按行或列查找值，支持向左/向右/模糊查找',
    },
    {
      type: 'fillBlank',
...
const quizProgress = loadProgress();
...
function renderQuizPanel(fnName) {
  ...
  if (!qs || qs.length === 0) {
    panel.innerHTML =
      '<div style="padding:40px 24px;text-align:center;color:var(--text-muted);">该函数暂无练习题</div>';
    return;
  }
  ...
  qs.forEach((q, idx) => {
    ...
    if (answered) {
      ...
      const tip = rec.correct
        ? '回答正确！'
        : `正确答案：${q.type === 'choice' ? ['A', 'B', 'C', 'D'][q.answer] + '. ' + q.options[q.answer] : q.answer}`;
...
function submitFill(fnName, idx) {
  ...
  // 答案比较（忽略空白、忽略大小写）
  const correct =
    userInput.toLowerCase().replace(/\s/g, '') === q.answer.toLowerCase().replace(/\s/g, '');
  if (!quizProgress[fnName]) quizProgress[fnName] = {};
...
function renderQuizCenter() {
  ...
  const wrongHtml = stats.wrong.length
    ? stats.wrong
        .map(
          (fn) =>
            `<span class="qc-wrong-item" onclick="closeQuizCenter();openModal('${fn}');setTimeout(()=>switchTab('quiz'),100)">${fn}</span>`
        )
        .join('')
...
function renderWrongBook() {
  ...
  const cardsHtml = wrongItems
    .map(({ fn, idx, q, rec }) => {
      const meta =
        CAT_META[(FUNCTIONS.find((f) => f.name === fn) || {}).category] || CAT_META['其他函数'];
      const letters = ['A', 'B', 'C', 'D'];
      let answerDisplay = '';
      if (q.type === 'choice') {
        answerDisplay = `正确答案：<strong>${letters[q.answer]}. ${escHtml(q.options[q.answer])}</strong>`;
        const yourChoice =
          rec.chosen !== undefined
            ? `${letters[rec.chosen]}. ${escHtml(q.options[rec.chosen] || '?')}`
            : '未选择';
