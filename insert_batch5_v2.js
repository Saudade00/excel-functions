// insert_batch5_v2.js
// 第五批（修正版）：向 QUIZ_DATA 插入 30 个新函数的练习题
// 关键修正：QUIZ_DATA 的键是 "FUNC": [ 格式（带引号），不是 FUNC: [
...
const newBatch = {
  "ABS": [
    {
      ...
      answer: 0,
      explanation: "ABS(number) 返回一个数的绝对值，即去掉负号的数值。例如 ABS(-10)=10。"
    }
  ],
  "ACCRINT": [
    {
  ...
  "ACOS": [
    {
      type: "choice",
      question: "ACOS(0) 的返回值是多少（弧度，保留4位小数）？",
      options: ["0", "1.5708", "3.1416", "0.7071"],
      answer: 1,
      explanation: "ACOS 是反余弦函数，ACOS(0)=π/2≈1.5708（弧度）。"
    }
  ],
  "ACOSH": [
    {
  ...
  "AMORDEGRC": [
    {
      ...
      answer: 0,
      explanation: "AMORDEGRC 是财务函数，使用折旧系数计算每个记账期的折旧值（法国会计准则）。"
    }
  ],
  "AMORLINC": [
    {
  ...
  "ASIN": [
    {
      type: "choice",
      question: "ASIN(1) 的返回值约等于多少（弧度）？",
      options: ["0", "1.5708", "3.1416", "0.7854"],
      answer: 1,
  ...
  "ATAN": [
    {
      ...
      options: ["0.7854（π/4）", "1.0", "1.5708（π/2）", "3.1416（π）"],
      answer: 0,
      explanation: "ATAN 是反正切函数，ATAN(1)=π/4≈0.7854 弧度（即 45°）。"
    }
  ],
  "ATAN2": [
    {
